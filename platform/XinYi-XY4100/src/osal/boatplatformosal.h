...
/*!@brief Define the abstract types of OSAL based on  openCPU OS,
...
//!@brief Abstract definition of mutex object based on  openCPU OS
#ifndef PLATFORM_OSAL_MUTEX
#define PLATFORM_OSAL_MUTEX
struct boatPlatformMutex{
    osMutexId_t mutexID; //!  mutex descriptor
};
#endif/////PLATFORM_OSAL_MUTEX

//!@brief Abstract definition of task object based on  openCPU OS
#ifndef PLATFORM_OSAL_TASK
#define PLATFORM_OSAL_TASK
struct boatPlatformTask{
    osThreadId_t taskId; //!  thread descriptor
    void *stackPtr;
};
#endif/////PLATFORM_OSAL_TASK

//!@brief Abstract definition of timer object based on  openCPU OS
#ifndef PLATFORM_OSAL_TIMER
#define PLATFORM_OSAL_TIMER
struct boatPlatformTimer{
    osTimerId_t timerId; //!  timer descriptor
};
#endif/////PLATFORM_OSAL_TIMER



//!@brief Abstract definition of semaphore object based on  openCPU OS
#ifndef PLATFORM_OSAL_SEM
#define PLATFORM_OSAL_SEM
#define FIBO_SEM_MUTEX

struct boatPlatformSem{
    osSemaphoreId_t semId; //!  semaphore descriptor
};
#endif/////PLATFORM_OSAL_SEM

//!@brief Abstract definition of message queue object based on  openCPU OS
#ifndef PLATFORM_OSAL_QUEUE
#define PLATFORM_OSAL_QUEUE
struct boatPlatformQueue{
    osMessageQueueId_t queueId; //! message queue descriptor
