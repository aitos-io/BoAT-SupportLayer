...
struct boatPlatformMutex{
    mbtk_mutexref mutexID; //!  mutex descriptor
};
...
struct boatPlatformTask{
    mbtk_taskref taskId; //!  thread descriptor
    void *stackPtr;
};
...
struct boatPlatformTimer{
    mbtk_ostimerref timerId; //!  timer descriptor
};
...
struct boatPlatformSem{
    mbtk_semref semId; //!  semaphore descriptor
};
...
struct boatPlatformQueue{
    mbtk_msgqref queueId; //! message queue descriptor
