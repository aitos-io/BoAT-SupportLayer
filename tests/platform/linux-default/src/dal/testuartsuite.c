...
START_TEST(test_BoAT_DAL_FibocomL610_01Uart_test_0012_boatUartInit_Failed_linuxUartOpenError)
{
	BOAT_RESULT rtnVal;
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0012_boatUartInit_Failed_linuxUartOpenError\r\n");
	...
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0012_boatUartInit_Failed_linuxUartOpenError finished\r\n");

}
END_TEST

START_TEST(test_BoAT_DAL_FibocomL610_01Uart_test_0013_boatUartInit_Failed_portOverMax)
{
	BOAT_RESULT rtnVal;
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0013_boatUartInit_Failed_portOverMax\r\n");
	//testUartConfigSet(&testUartConfig, 115200, 8, 1, 0, 0, 0);
	for(BUINT8 i = 0;; i++)
	{
	...
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0013_boatUartInit_Failed_portOverMax finished\r\n");
...
START_TEST(test_BoAT_DAL_FibocomL610_01Uart_test_0022_boatUartDeinit_Failed_linuxUartCloseError)
{
	BOAT_RESULT rtnVal;
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0022_boatUartDeinit_Failed_linuxUartCloseError\r\n");
	...
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0022_boatUartDeinit_Failed_linuxUartCloseError finished\r\n");
...
START_TEST(test_BoAT_DAL_FibocomL610_01Uart_test_0028_boatUartWrite_Failed_linuxUartCloseError)
{
	BOAT_RESULT rtnVal;
	BUINT8 tdBuf[10];
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0028_boatUartWrite_Failed_linuxUartCloseError\r\n");

	rtnVal = boatUartWrite(&testUartId, tdBuf, sizeof(tdBuf));
	ck_assert_int_eq(rtnVal,BOAT_ERROR);

	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0028_boatUartWrite_Failed_linuxUartCloseError finished\r\n");

}
END_TEST

START_TEST(test_BoAT_DAL_FibocomL610_01Uart_test_0029_boatUartWriteRead_IntegrityTest)
{
	BOAT_RESULT rtnVal;
	/////BUINT8 tdBuf[7]={0,'a','i','t','o','s',0xfb};
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0029_boatUartWriteRead_IntegrityTest\r\n");
	testUartConfigSet(&testUartConfig, 115200, 8, 1, 0, 0, 0);
	...
	rtnVal = boatUartDeinit(&testUartId);
	ck_assert_int_eq(rtnVal,BOAT_SUCCESS);
	BoatLog(BOAT_LOG_NORMAL, "Testing test_BoAT_DAL_FibocomL610_01Uart_test_0029_boatUartWriteRead_IntegrityTest finished\r\n");
...
Suite *makeUarttest_suite(void)
{
	...
	tcase_add_test(tcUarttest_api, test_BoAT_DAL_FibocomL610_01Uart_test_0012_boatUartInit_Failed_linuxUartOpenError);
	tcase_add_test(tcUarttest_api, test_BoAT_DAL_FibocomL610_01Uart_test_0013_boatUartInit_Failed_portOverMax);
	...
	tcase_add_test(tcUarttest_api, test_BoAT_DAL_FibocomL610_01Uart_test_0022_boatUartDeinit_Failed_linuxUartCloseError);
	...
	tcase_add_test(tcUarttest_api, test_BoAT_DAL_FibocomL610_01Uart_test_0028_boatUartWrite_Failed_linuxUartCloseError);
	tcase_add_test(tcUarttest_api, test_BoAT_DAL_FibocomL610_01Uart_test_0029_boatUartWriteRead_IntegrityTest);
#endif
    return sUarttest;
